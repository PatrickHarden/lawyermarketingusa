          ...
          posts.map(function (post) {
            return _react2.default.createElement(
              ...
              _react2.default.createElement(
                _reactStatic.Link,
                { to: '/blogs/' + post.slug + '/' },
                _react2.default.createElement(_reactstrap.CardImg, { top: true, width: '100%', src: post.better_featured_image.media_details.sizes.medium.source_url })
              ),
              _react2.default.createElement(
...
exports.default = (0, _reactStatic.withRouteData)(function (_ref) {
  var practiceArea = _ref.practiceArea;
  return _react2.default.createElement(
    'section',
    null,
    _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          (0, _reactHtmlParser2.default)(practiceArea.content.rendered)
        )
      )
    )
  );
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          { className: 'card-columns' },
          areas.map(function (practiceArea) {
            return _react2.default.createElement(
              _reactstrap.Card,
              { key: practiceArea.id, className: "card-" + practiceArea.id },
              _react2.default.createElement(
                _reactStatic.Link,
                { to: '/practice-area/' + practiceArea.slug + '/' },
                _react2.default.createElement(_reactstrap.CardImg, { top: true, width: '100%', src: practiceArea.better_featured_image ? practiceArea.better_featured_image.media_details.sizes.medium.source_url : '' })
              ),
              _react2.default.createElement(
                _reactstrap.CardBody,
                null,
                ...
                _react2.default.createElement(
                  _reactstrap.CardText,
                  null,
                  (0, _reactHtmlParser2.default)(practiceArea.excerpt.rendered)
                ),
                _react2.default.createElement(
                  _reactstrap.CardText,
                  null,
...
exports.default = (0, _reactStatic.withRouteData)(function (_ref) {
  var staffMember = _ref.staffMember;
  return _react2.default.createElement(
    'section',
    null,
    _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            null,
            'Staff - ',
            staffMember.title.rendered
          ),
          (0, _reactHtmlParser2.default)(staffMember.content.rendered)
        )
      )
    )
  );
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          staff.map(function (staffMember) {
            return _react2.default.createElement(
              _reactstrap.Card,
              { key: staffMember.id, className: "card-" + staffMember.id },
              _react2.default.createElement(
                _reactStatic.Link,
                { to: '/staff/' + staffMember.slug + '/' },
                _react2.default.createElement(_reactstrap.CardImg, { top: true, width: '100%', src: staffMember.better_featured_image ? staffMember.better_featured_image.media_details.sizes.medium.source_url : '' })
              ),
              _react2.default.createElement(
                _reactstrap.CardBody,
                null,
                ...
                _react2.default.createElement(
                  _reactstrap.CardText,
                  null,
                  (0, _reactHtmlParser2.default)(staffMember.excerpt.rendered)
                ),
                _react2.default.createElement(
                  _reactstrap.CardText,
                  null,
...
// module
exports.push([module.i, ".row{width:100%!important}", ""]);
...
})(['a{text-decoration:none;color:#108db8;font-weight:bold;}.content{padding:1rem;}img{max-width:100%;}']);
...
var t_0 = (0, _reactUniversalComponent2.default)((0, _universalImport3.default)({
  ...
  file: '/Users/developer/Desktop/playground/attorneytemplate.com/dist/react-static-routes.js',
  load: function load() {
...
var t_2 = (0, _reactUniversalComponent2.default)((0, _universalImport3.default)({
  id: '../src/containers/Areas',
  file: '/Users/developer/Desktop/playground/attorneytemplate.com/dist/react-static-routes.js',
  load: function load() {
    return Promise.all([new Promise(function(resolve) { resolve(); }).then(__webpack_require__.bind(null, 9)), (0, _importCss3.default)('src/containers/Areas', {
      disableWarnings: true
    })]).then(function (proms) {
      return proms[0];
    });
  ...
  path: function path() {
    return _path3.default.join(__dirname, '../src/containers/Areas');
  },
  resolve: function resolve() {
    return /*require.resolve*/(9);
  },
  chunkName: function chunkName() {
    return 'src/containers/Areas';
  }
}), universalOptions);
var t_3 = (0, _reactUniversalComponent2.default)((0, _universalImport3.default)({
  id: '../src/containers/AreaArchive',
  file: '/Users/developer/Desktop/playground/attorneytemplate.com/dist/react-static-routes.js',
  load: function load() {
    return Promise.all([new Promise(function(resolve) { resolve(); }).then(__webpack_require__.bind(null, 10)), (0, _importCss3.default)('src/containers/AreaArchive', {
      disableWarnings: true
    })]).then(function (proms) {
      return proms[0];
    });
  ...
  path: function path() {
    return _path3.default.join(__dirname, '../src/containers/AreaArchive');
  },
  resolve: function resolve() {
    return /*require.resolve*/(10);
  },
  chunkName: function chunkName() {
    return 'src/containers/AreaArchive';
  }
}), universalOptions);
var t_4 = (0, _reactUniversalComponent2.default)((0, _universalImport3.default)({
  id: '../src/containers/Staff',
  file: '/Users/developer/Desktop/playground/attorneytemplate.com/dist/react-static-routes.js',
  load: function load() {
    return Promise.all([new Promise(function(resolve) { resolve(); }).then(__webpack_require__.bind(null, 11)), (0, _importCss3.default)('src/containers/Staff', {
      disableWarnings: true
    })]).then(function (proms) {
      return proms[0];
    });
  ...
  path: function path() {
    return _path3.default.join(__dirname, '../src/containers/Staff');
  },
  resolve: function resolve() {
    return /*require.resolve*/(11);
  },
  chunkName: function chunkName() {
    return 'src/containers/Staff';
  }
}), universalOptions);
var t_5 = (0, _reactUniversalComponent2.default)((0, _universalImport3.default)({
  id: '../src/containers/StaffArchive',
  file: '/Users/developer/Desktop/playground/attorneytemplate.com/dist/react-static-routes.js',
  load: function load() {
    return Promise.all([new Promise(function(resolve) { resolve(); }).then(__webpack_require__.bind(null, 12)), (0, _importCss3.default)('src/containers/StaffArchive', {
      disableWarnings: true
    })]).then(function (proms) {
      return proms[0];
    });
  ...
  path: function path() {
    return _path3.default.join(__dirname, '../src/containers/StaffArchive');
  },
  resolve: function resolve() {
    return /*require.resolve*/(12);
  },
  chunkName: function chunkName() {
    return 'src/containers/StaffArchive';
  }
}), universalOptions);
var t_6 = (0, _reactUniversalComponent2.default)((0, _universalImport3.default)({
  ...
  file: '/Users/developer/Desktop/playground/attorneytemplate.com/dist/react-static-routes.js',
  load: function load() {
    return Promise.all([new Promise(function(resolve) { resolve(); }).then(__webpack_require__.bind(null, 13)), (0, _importCss3.default)('src/containers/Contact', {
      disableWarnings: true
    })]).then(function (proms) {
      return proms[0];
    });
...
var t_7 = (0, _reactUniversalComponent2.default)((0, _universalImport3.default)({
  ...
  file: '/Users/developer/Desktop/playground/attorneytemplate.com/dist/react-static-routes.js',
  load: function load() {
    return Promise.all([new Promise(function(resolve) { resolve(); }).then(__webpack_require__.bind(null, 14)), (0, _importCss3.default)('src/containers/Page', {
      disableWarnings: true
    })]).then(function (proms) {
      return proms[0];
    });
...
var _MenuItems = __webpack_require__(35);
              ...
              _react2.default.createElement(
                ...
                _react2.default.createElement(
                  ...
                  _react2.default.createElement(
                    ...
                    _react2.default.createElement(_MenuItems2.default, null),
                    _react2.default.createElement(
                      _reactstrap.NavItem,
                      null,
                      _react2.default.createElement(
            ...
            return menus.items.map(function (menu, i) {
                return _react2.default.createElement(
                    ...
                    menu.children ? _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            menu.children.map(function (children, i) {
                                return _react2.default.createElement(
                                    ...
                                    _react2.default.createElement(
                                        _reactStatic.Link,
                                        { to: "/" + children.object + "/" + children.object_slug, className: 'nav-link' },
                                        children.title
                                    )
                                );
                            })
                        ...
                        _react2.default.createElement(
                            _reactStatic.Link,
                            { to: '/' + menu.object_slug, className: 'nav-link' },
                            menu.title
                        )
                    )
                );
...
//# sourceMappingURL=static.bbcdc082.js.map
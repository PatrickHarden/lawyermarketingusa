...
var buildXMLandRSS = exports.buildXMLandRSS = function () {
  var _ref11 = _asyncToGenerator( /*#__PURE__*/_regenerator2.default.mark(function _callee7(_ref12) {
    ...
    var siteRoot, prefixPath, xml, generateXML;
      ...
      while (1) {
        switch (_context7.prev = _context7.next) {
          case 0:
            ...
            siteRoot = process.env.REACT_STATIC_STAGING ? config.stagingSiteRoot : config.siteRoot;
          ...
          case 4:
            prefixPath = config.disableRoutePrefixing ? siteRoot : config.publicPath;
            xml = generateXML({
              routes: config.routes.filter(function (d) {
                return !d.is404;
              }).map(function (route) {
                return _extends({
                  permalink: prefixPath + '/' + (0, _shared.pathJoin)(route.path),
                  lastModified: '',
                  priority: 0.5
                }, route);
              })
